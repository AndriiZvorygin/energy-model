    ...
    <div>
      <section className="research-grid border-b border-stone-200 bg-white px-5 py-12 sm:px-8 lg:px-12 lg:py-20 dark:border-stone-800 dark:bg-[#151c1a]">
        <div className="mx-auto max-w-6xl">
          <p className="text-xs font-semibold uppercase tracking-widest text-petroleum">Canadian-centred research with global inputs</p>
          ...
          <p className="mt-6 max-w-3xl text-lg leading-8 text-stone-600 dark:text-stone-300">The observatory studies Canadian energy-economic conditions within global liquidity and oil markets. United States evidence remains available as a comparison dataset.</p>
          <div className="mt-8 flex flex-wrap gap-3">
            <Link to="/canada/current-state" className="inline-flex items-center gap-2 rounded-md bg-petroleum px-4 py-2.5 text-sm font-semibold text-white">Explore Canadian evidence <ArrowRight size={16} /></Link>
      ...
      <section className="mx-auto max-w-6xl px-5 py-12 sm:px-8 lg:px-12 lg:py-16">
        <div className="mb-8 flex flex-wrap items-end justify-between gap-4"><div><p className="text-xs font-semibold uppercase tracking-widest text-petroleum">Diagnostic layers</p><h2 className="mt-2 text-2xl font-semibold">Read the sequence without reducing it to one score</h2></div><Link to="/canada/current-state" className="inline-flex items-center gap-2 text-sm font-semibold text-petroleum">View Canadian readings <ArrowRight size={15} /></Link></div>
