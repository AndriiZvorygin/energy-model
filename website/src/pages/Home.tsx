      ...
      <section className="research-grid border-b border-stone-200 bg-white px-5 py-12 sm:px-8 lg:px-12 lg:py-20 dark:border-stone-800 dark:bg-[#151c1a]">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link to="/system-response" className="inline-flex items-center gap-2 rounded-md bg-petroleum px-4 py-2.5 text-sm font-semibold text-white">Explore the system <ArrowRight size={16} /></Link>
