...
export function Canada() {
  return <><PageHeader eyebrow="Primary domestic geography" title="Canadian energy-economic conditions" description="Canada is the observatory's domestic evidence layer, interpreted alongside global liquidity and oil markets without replacing the locked benchmark model or the U.S. comparison dataset." /><PageBody><CanadaGeographyControls /><section className="mt-10"><p className="max-w-4xl text-lg leading-8 text-stone-600 dark:text-stone-300">This release adds a provisional transparent Canadian classifier over the existing evidence. Household stress remains unevaluable, and Ontario and Alberta contributions stay separate.</p><div className="mt-8 grid gap-px border border-stone-200 bg-stone-200 md:grid-cols-2 dark:border-stone-800 dark:bg-stone-800">{[
    ...
    [Factory, 'Canadian regimes', 'Compare eight provisional states, coverage, freshness and regional evidence.', '/canada/regimes'],
    [Banknote, 'Canadian symptoms', 'Inspect active, emerging, fading, inactive and unavailable patterns.', '/canada/symptoms'],
