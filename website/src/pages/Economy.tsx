...
export function Economy() {
  ...
  return <><PageHeader eyebrow="Physical economy" title="Energy throughput anchors measured activity" description="Energy and petroleum consumption move tightly with real GDP at quarterly frequency, while rising GDP per energy captures efficiency and structural change." /><PageBody>
    <p className="max-w-4xl text-sm leading-6 text-stone-600 dark:text-stone-300">All four growth series are synchronized to genuine quarterly observations. Monthly energy and industrial data are aggregated to quarters; GDP is not interpolated into false monthly precision.</p>
    <div className="mt-8"><ResearchTimeSeriesChart file="energy-gdp.json" initialTransformation="raw" inspectCrossLayer /></div>
    ...
    <div className="mt-12 space-y-6"><PublicationFigure src="/charts/final_energy_gdp_time_series.png" alt="Energy consumption petroleum consumption real GDP and industrial production growth with GDP per energy trend" title="Energy and real activity through time" description="The upper panel compares growth rates; the lower panel shows how measured output per unit of energy has risen." source="EIA total energy and petroleum consumption; FRED GDPC1 and INDPRO." /><PublicationFigure src="/charts/gdp_per_energy_trend.png" alt="Long-run trend in GDP per unit of energy" title="Efficiency and structural change" description="The economy remains physically grounded in energy throughput while producing more measured GDP per unit consumed." source="Real GDP divided by U.S. total energy consumption." /></div>
  </PageBody></>
}
